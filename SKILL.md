...
| Proposing a tool or a dependency, or a licence/scan finding | `project-setup.md` § License compatibility, § Tools that do not clear the bar |
...
| Commit messages | **Conventional Commits** carrying the ticket number, enforced by `commitlint` |
