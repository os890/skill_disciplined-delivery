...
Generated content (OpenAPI, Javadoc, coverage reports) is regenerated by the build and linked, never copied by hand into Markdown — a hand-copied API reference is wrong within a week.
